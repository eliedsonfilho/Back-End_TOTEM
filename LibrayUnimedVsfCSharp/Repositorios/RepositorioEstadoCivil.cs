...
{
    public class RepositorioEstadoCivil : Repositorio, IRepositorio<EstadoCivil, string>
    {
        public EstadoCivil ObterPorId(string autoIdBoleto, bool lazy)
        {
            IDbCommand command;
            //IDataReader dataReaderTmp;
            EstadoCivil objetoPesquisado = new EstadoCivil();
            ...
            try
            {
                command = new SqlCommand(@"Select 
                                            *
                                            From 
                                            EstadoCivil where codigo = @codigo");
        ...
        public IList<EstadoCivil> ObterTodos(bool lazy)
        {
            //IDataReader dataReaderTmp;
            IList<EstadoCivil> listaObjetosPesquisados = null;
            EstadoCivil objetoPesquisado = new EstadoCivil();
        ...
        public IList<EstadoCivil> ObterTodos(EstadoCivil objetoPesquisado, bool lazy)
        {
            //IDataReader dataReaderTmp;
            IList<EstadoCivil> listaObjetosPesquisados = null;
            IDbCommand command = null;
