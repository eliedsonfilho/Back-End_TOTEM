...
{
    public class RepositorioTelefonePessoa : Repositorio, IRepositorio<TelefonePessoa, int>
    {
        public TelefonePessoa ObterPorId(int autoIdBoleto, bool lazy)
        {
            IDbCommand command;
            //IDataReader dataReaderTmp;
            TelefonePessoa objetoPesquisado = new TelefonePessoa();
            ...
            try
            {
                command = new SqlCommand(@"Select 
                                            *
                                            From 
                                            TelefonePessoa where autoId = @autoId");
        ...
        public IList<TelefonePessoa> ObterTodos(bool lazy)
        {
            //IDataReader dataReaderTmp;
            IList<TelefonePessoa> listaObjetosPesquisados = null;
            TelefonePessoa objetoPesquisado = new TelefonePessoa();
        ...
        public IList<TelefonePessoa> ObterTodos(TelefonePessoa objetoPesquisado, bool lazy)
        {
            //IDataReader dataReaderTmp;
            IList<TelefonePessoa> listaObjetosPesquisados = null;
            IDbCommand command = null;
