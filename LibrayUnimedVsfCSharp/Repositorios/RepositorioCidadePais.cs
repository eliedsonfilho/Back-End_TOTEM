...
{
    public class RepositorioCidadePais : Repositorio, IRepositorio<CidadePais, int>
    {
        public CidadePais ObterPorId(int autoIdBoleto, bool lazy)
        {
            IDbCommand command;
            //IDataReader dataReaderTmp;
            CidadePais objetoPesquisado = new CidadePais();
            ...
            try
            {
                command = new SqlCommand(@"Select 
                                            *
                                            From 
                                            CidadePais where codigo = @codigo");
        ...
        public IList<CidadePais> ObterTodos(bool lazy)
        {
            //IDataReader dataReaderTmp;
            IList<CidadePais> listaObjetosPesquisados = null;
            CidadePais objetoPesquisado = new CidadePais();
        ...
        public IList<CidadePais> ObterTodos(CidadePais objetoPesquisado, bool lazy)
        {
            //IDataReader dataReaderTmp;
            IList<CidadePais> listaObjetosPesquisados = null;
            IDbCommand command = null;
