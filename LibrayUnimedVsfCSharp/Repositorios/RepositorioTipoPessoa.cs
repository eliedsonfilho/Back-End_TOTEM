...
{
    public class RepositorioTipoPessoa : Repositorio, IRepositorio<TipoPessoa, int>
    {
        public TipoPessoa ObterPorId(int autoIdBoleto, bool lazy)
        {
            IDbCommand command;
            //IDataReader dataReaderTmp;
            TipoPessoa objetoPesquisado = new TipoPessoa();
            ...
            try
            {
                command = new SqlCommand(@"Select 
                                            *
                                            From 
                                            TipoPessoa where codigo = @codigo");
        ...
        public IList<TipoPessoa> ObterTodos(bool lazy)
        {
            IDataReader dataReaderTmp;
            IList<TipoPessoa> listaObjetosPesquisados = null;
            TipoPessoa objetoPesquisado = new TipoPessoa();
        ...
        public IList<TipoPessoa> ObterTodos(TipoPessoa objetoPesquisado, bool lazy)
        {
            //IDataReader dataReaderTmp;
            IList<TipoPessoa> listaObjetosPesquisados = null;
            IDbCommand command = null;
