...
{
    public class RepositorioGrauDepPessoa : Repositorio, IRepositorio<GrauDepPessoa, int>
    {
        public GrauDepPessoa ObterPorId(int autoIdBoleto, bool lazy)
        {
            IDbCommand command;
            //IDataReader dataReaderTmp;
            GrauDepPessoa objetoPesquisado = new GrauDepPessoa();
            ...
            try
            {
                command = new SqlCommand(@"Select 
                                            *
                                            From 
                                            GrauDepPessoa where codigo = @codigo");
        ...
        public IList<GrauDepPessoa> ObterTodos(bool lazy)
        {
            //IDataReader dataReaderTmp;
            IList<GrauDepPessoa> listaObjetosPesquisados = null;
            GrauDepPessoa objetoPesquisado = new GrauDepPessoa();
        ...
        public IList<GrauDepPessoa> ObterTodos(GrauDepPessoa objetoPesquisado, bool lazy)
        {
            //IDataReader dataReaderTmp;
            IList<GrauDepPessoa> listaObjetosPesquisados = null;
            IDbCommand command = null;
