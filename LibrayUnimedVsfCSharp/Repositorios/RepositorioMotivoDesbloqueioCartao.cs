...
{
    public class RepositorioMotivoDesbloqueioCartao : Repositorio, IRepositorio<MotivoDesbloqueioCartao, int>
    {
        public MotivoDesbloqueioCartao ObterPorId(int autoIdBoleto, bool lazy)
        {
            IDbCommand command;
            //IDataReader dataReaderTmp;
            MotivoDesbloqueioCartao objetoPesquisado = new MotivoDesbloqueioCartao();
            ...
            try
            {
                command = new SqlCommand(@"Select 
                                            *
                                            From 
                                            MotivoDesbloqueioCartao where codigo = @codigo");
        ...
        public IList<MotivoDesbloqueioCartao> ObterTodos(bool lazy)
        {
            //IDataReader dataReaderTmp;
            IList<MotivoDesbloqueioCartao> listaObjetosPesquisados = null;
            MotivoDesbloqueioCartao objetoPesquisado = new MotivoDesbloqueioCartao();
        ...
        public IList<MotivoDesbloqueioCartao> ObterTodos(MotivoDesbloqueioCartao objetoPesquisado, bool lazy)
        {
            //IDataReader dataReaderTmp;
            IList<MotivoDesbloqueioCartao> listaObjetosPesquisados = null;
            IDbCommand command = null;
