...
{
    public class RepositorioEnderecoPessoa : Repositorio, IRepositorio<EnderecoPessoa, int>
    {
        public EnderecoPessoa ObterPorId(int autoIdBoleto, bool lazy)
        {
            IDbCommand command;
            //IDataReader dataReaderTmp;
            EnderecoPessoa objetoPesquisado = new EnderecoPessoa();
            ...
            try
            {
                command = new SqlCommand(@"Select 
                                            *
                                            From 
                                            EnderecoPessoa where autoId = @autoId");
        ...
        public IList<EnderecoPessoa> ObterTodos(bool lazy)
        {
            //IDataReader dataReaderTmp;
            IList<EnderecoPessoa> listaObjetosPesquisados = null;
            EnderecoPessoa objetoPesquisado = new EnderecoPessoa();
        ...
        public IList<EnderecoPessoa> ObterTodos(EnderecoPessoa objetoPesquisado, bool lazy)
        {
            //IDataReader dataReaderTmp;
            IList<EnderecoPessoa> listaObjetosPesquisados = null;
            IDbCommand command = null;
