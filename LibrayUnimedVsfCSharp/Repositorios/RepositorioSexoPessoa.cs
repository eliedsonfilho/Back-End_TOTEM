...
{
    public class RepositorioSexoPessoa : Repositorio, IRepositorio<SexoPessoa, string>
    {
        public SexoPessoa ObterPorId(string autoIdBoleto, bool lazy)
        {
            IDbCommand command;
            //IDataReader dataReaderTmp;
            SexoPessoa objetoPesquisado = new SexoPessoa();
            ...
            try
            {
                command = new SqlCommand(@"Select 
                                            *
                                            From 
                                            SexoPessoa where codigo = @codigo");
        ...
        public IList<SexoPessoa> ObterTodos(bool lazy)
        {
            //IDataReader dataReaderTmp;
            IList<SexoPessoa> listaObjetosPesquisados = null;
            SexoPessoa objetoPesquisado = new SexoPessoa();
        ...
        public IList<SexoPessoa> ObterTodos(SexoPessoa objetoPesquisado, bool lazy)
        {
            //IDataReader dataReaderTmp;
            IList<SexoPessoa> listaObjetosPesquisados = null;
            IDbCommand command = null;
