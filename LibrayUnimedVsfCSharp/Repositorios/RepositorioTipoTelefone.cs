...
{
    public class RepositorioTipoTelefone : Repositorio, IRepositorio<TipoTelefone, int>
    {
        public TipoTelefone ObterPorId(int autoIdBoleto, bool lazy)
        {
            IDbCommand command;
            //IDataReader dataReaderTmp;
            TipoTelefone objetoPesquisado = new TipoTelefone();
            ...
            try
            {
                command = new SqlCommand(@"Select 
                                            *
                                            From 
                                            TipoTelefone where codigo = @codigo");
        ...
        public IList<TipoTelefone> ObterTodos(bool lazy)
        {
           // IDataReader dataReaderTmp;
            IList<TipoTelefone> listaObjetosPesquisados = null;
            TipoTelefone objetoPesquisado = new TipoTelefone();
        ...
        public IList<TipoTelefone> ObterTodos(TipoTelefone objetoPesquisado, bool lazy)
        {
            //IDataReader dataReaderTmp;
            IList<TipoTelefone> listaObjetosPesquisados = null;
            IDbCommand command = null;
