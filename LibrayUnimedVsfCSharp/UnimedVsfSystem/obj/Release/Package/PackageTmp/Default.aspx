<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="UnimedVsfSystem.Default" %>
    ...
    <div>
        ...
        <table border="0">
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="txtBanco" runat="Server">
                        ...
                        <asp:ListItem Text="Banco Sicredi" Value="748" />
                    </asp:DropDownList>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtMoraMulta" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
